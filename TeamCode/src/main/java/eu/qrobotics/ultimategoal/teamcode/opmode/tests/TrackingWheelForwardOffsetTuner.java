...
import eu.qrobotics.ultimategoal.teamcode.subsystems.Odometry;
...
public class TrackingWheelForwardOffsetTuner extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        for (int i = 0; i < NUM_TRIALS; i++) {
            ...
            double forwardOffset = Odometry.REAR_POSE.getX() +
                    robot.drive.getPoseEstimate().getY() / headingAccumulator;

...
import eu.qrobotics.ultimategoal.teamcode.opmode.auto.trajectories.TrajectoriesTraditionalRedRight_Solo;
...
@Autonomous
//@Disabled
public class AutoTraditionalRedRight_Solo extends LinearOpMode {
...
//        telemetry = new MultipleTelemetry(super.telemetry, FtcDashboard.getInstance().getTelemetry());
        ...
        robot.drive.setPoseEstimate(TrajectoriesTraditionalRedRight_Solo.START_POSE);
        List<Trajectory> trajectoriesA = TrajectoriesTraditionalRedRight_Solo.getTrajectoriesA();
        List<Trajectory> trajectoriesB = TrajectoriesTraditionalRedRight_Solo.getTrajectoriesB();
        List<Trajectory> trajectoriesC = TrajectoriesTraditionalRedRight_Solo.getTrajectoriesC();
        robot.start();

...
//        FtcDashboard.getInstance().sendTelemetryPacket(packet);
        ...
        telemetry.update();
//        robot.top100Subsystems.forEach((subsystem, movingStatistics) -> {
//            Log.d("RobotTimesMean" + subsystem.getClass().getSimpleName(), movingStatistics.getMean() * 1000 + "ms");
//            Log.d("RobotTimesStdev" + subsystem.getClass().getSimpleName(),  movingStatistics.getStandardDeviation() * 1000 + "ms");
//        });
    }

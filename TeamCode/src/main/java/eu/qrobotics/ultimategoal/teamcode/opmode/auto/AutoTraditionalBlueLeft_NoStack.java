...
import eu.qrobotics.ultimategoal.teamcode.opmode.auto.trajectories.TrajectoriesTraditionalBlueLeft_NoStack;
...
@Autonomous
@Disabled
public class AutoTraditionalBlueLeft_NoStack extends LinearOpMode {
...
//        telemetry = new MultipleTelemetry(super.telemetry, FtcDashboard.getInstance().getTelemetry());
        ...
        robot.drive.setPoseEstimate(TrajectoriesTraditionalBlueLeft_NoStack.START_POSE);
        List<Trajectory> trajectoriesA = TrajectoriesTraditionalBlueLeft_NoStack.getTrajectoriesA();
        List<Trajectory> trajectoriesB = TrajectoriesTraditionalBlueLeft_NoStack.getTrajectoriesB();
        List<Trajectory> trajectoriesC = TrajectoriesTraditionalBlueLeft_NoStack.getTrajectoriesC();
        robot.start();

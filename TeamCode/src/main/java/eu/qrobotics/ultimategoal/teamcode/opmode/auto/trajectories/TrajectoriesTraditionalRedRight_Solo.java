...
public class TrajectoriesTraditionalRedRight_Solo {
    ...
    public static List<Trajectory> getTrajectoriesA() {
        ...
        trajectories.add(makeTrajectoryBuilder(trajectories, Math.toRadians(0))
                .splineToSplineHeading(new Pose2d(8, -56, Math.toRadians(-180)), Math.toRadians(0))
                .build());

        // get 2nd wobble
        trajectories.add(makeTrajectoryBuilder(trajectories, Math.toRadians(180), FASTER_VEL_CONSTRAINT, FASTER_ACCEL_CONSTRAINT)
                .splineToSplineHeading(new Pose2d(-37, -34, Math.toRadians(0)), Math.toRadians(180))
                .build());
    ...
    public static List<Trajectory> getTrajectoriesB() {
        ...
        // place first wobble
        trajectories.add(makeTrajectoryBuilder(trajectories, Math.toRadians(0), FASTER_VEL_CONSTRAINT, FASTER_ACCEL_CONSTRAINT)
                .splineToSplineHeading(new Pose2d(20, -40, Math.toRadians(180)), Math.toRadians(0))
                .build());
        ...
        // place 2nd wobble
        trajectories.add(makeTrajectoryBuilder(trajectories, Math.toRadians(0), FASTER_VEL_CONSTRAINT, FASTER_ACCEL_CONSTRAINT)
                .splineToSplineHeading(new Pose2d(20, -32, Math.toRadians(180)), Math.toRadians(0))
                .build());
    ...
    public static List<Trajectory> getTrajectoriesC() {
        ...
        // place first wobble
        trajectories.add(makeTrajectoryBuilder(trajectories, Math.toRadians(-90), FASTER_VEL_CONSTRAINT, FASTER_ACCEL_CONSTRAINT)
        ...
        // place 2nd wobble
        trajectories.add(makeTrajectoryBuilder(trajectories, Math.toRadians(0), FASTER_VEL_CONSTRAINT, FASTER_ACCEL_CONSTRAINT)
                .splineToSplineHeading(new Pose2d(43, -50, Math.toRadians(180)), Math.toRadians(0))
                .build());

        // park
        trajectories.add(makeTrajectoryBuilder(trajectories, Math.toRadians(180))
                .splineToSplineHeading(new Pose2d(12, -50, Math.toRadians(180)), Math.toRadians(180))
                .build());
